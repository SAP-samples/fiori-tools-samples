...
4. In the terminal, navigate to `fiori-tools-samples/V2/products-review` and execute `npm install` to install the necessary dependencies as mentioned in the `package.json` file
