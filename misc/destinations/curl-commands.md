...
| **HTTP 503 Service Unavailable** | Back-end system is unreachable or unavailable | If `ProxyType=OnPremise`, investigate the Cloud Connector configuration and connectivity. Verify the Virtual Host Mapping, Access Control settings, and Cloud Connector availability. See the [on-premise troubleshooting guide](../onpremise/README.md) for detailed steps. |
