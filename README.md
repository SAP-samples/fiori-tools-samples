...
<table style="border: none;"><tr><td style="border: none; padding: 12px;"><a href="https://marketplace.visualstudio.com/items?itemName=SAPSE.sap-ux-fiori-tools-extension-pack"><img src="assets/fiori-tools-icon.png" alt="SAP Fiori Tools" width="80"/></a></td><td style="border: none; padding: 12px;"><h1>SAP Fiori Tools Samples</h1></td></tr></table>
...
- **Tutorial issues**: Report in the [SAP Tutorials repository](https://github.com/SAPDocuments/Tutorials/issues/new)
